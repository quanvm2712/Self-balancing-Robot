...
extern double actualTemperature;
extern double actualHumidity;
void AHT20_Init(){
	delay_ms(10);
...
void AHT20_ReadData() {
    ...
    if (!(status & 0x80)) {
        ...
        actualTemperature = ((double)temperature * 200 / 1048576.0) - 50;
        actualHumidity= ((double)humidity * 100) / 1048576.0;
